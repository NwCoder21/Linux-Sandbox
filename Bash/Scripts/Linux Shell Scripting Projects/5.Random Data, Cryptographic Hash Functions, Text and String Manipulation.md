...
![image](https://user-images.githubusercontent.com/107522496/207464815-b91c22d8-896a-4137-97eb-7a2b067b4f1d.png)

```yaml
# A more complex password 
PASSWORD=$(date +%s%N{RANDOM}{RANDOM}  | sha256sum | head -c18)
echo "${PASSWORD}"
```
...
Iif we want to change our entire line of special characters into separate lines, then we simply need a width of one.
